...
alias createdevelopbranch='git checkout master && git branch -D develop | git checkout -b develop && git merge uJoystick missions scripts pSimplePID pSecuritySurface'
